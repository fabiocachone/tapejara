...
// ---- CONFIG Wi-Fi ----
const char* ssid = "tapejara01"; //hotspot
const char* password = "tpj@ufabc2025"; //senha
...
costant char* mqtt_telemetria = "drone/telemetria"
...
client.publish(mqtt_topic_telemetria, payload);
